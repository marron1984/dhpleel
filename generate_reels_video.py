...
SCENES = [
    {   # オープニング — 店名
        ...
        "effect": "zoom_in",
        "texts": [
            {"text": "MICHELIN SELECTED", "y": 0.31, "size": 20, "color": GOLD, "spacing": 6, "font": "accent"},
            {"text": "━━━━", "y": 0.37, "size": 16, "color": GOLD},
            {"text": "北新地  大嵓埜", "y": 0.43, "size": 50, "color": WHITE, "spacing": 14, "font": "title"},
            {"text": "季節の恵みを味わう、特別なひととき", "y": 0.52, "size": 20, "color": GOLD_LIGHT, "spacing": 3, "font": "body"},
        ],
        "text_delay": 0.5,
    },
    {   # 先付け
        ...
        "effect": "zoom_out",
        "texts": [
            {"text": "先付け", "y": 0.78, "size": 42, "color": WHITE, "spacing": 10, "align": "left", "font": "title"},
            {"text": "爽やかな季節野菜のハーモニー", "y": 0.85, "size": 18, "color": (220, 220, 220), "spacing": 2, "align": "left", "font": "body"},
        ],
        "text_delay": 0.4,
    },
    {   # 刺身
        ...
        "effect": "pan_right",
        "texts": [
            {"text": "刺  身", "y": 0.78, "size": 42, "color": WHITE, "spacing": 10, "align": "left", "font": "title"},
            {"text": "海の恵みを華やかに", "y": 0.85, "size": 18, "color": (220, 220, 220), "spacing": 2, "align": "left", "font": "body"},
        ],
        "text_delay": 0.4,
    },
    {   # 焼き物
        ...
        "effect": "zoom_in",
        "texts": [
            {"text": "焼き物", "y": 0.78, "size": 42, "color": WHITE, "spacing": 10, "align": "left", "font": "title"},
            {"text": "香ばしい竹の子と帆立", "y": 0.85, "size": 18, "color": (220, 220, 220), "spacing": 2, "align": "left", "font": "body"},
        ],
        "text_delay": 0.4,
    },
    {   # 揚げ物
        ...
        "effect": "pan_left",
        "texts": [
            {"text": "揚げ物", "y": 0.78, "size": 42, "color": WHITE, "spacing": 10, "align": "left", "font": "title"},
            {"text": "サクサクの食感で心を掴む", "y": 0.85, "size": 18, "color": (220, 220, 220), "spacing": 2, "align": "left", "font": "body"},
        ],
        "text_delay": 0.4,
    },
    {   # 強肴
        ...
        "effect": "zoom_out",
        "texts": [
            {"text": "強  肴", "y": 0.78, "size": 42, "color": WHITE, "spacing": 10, "align": "left", "font": "title"},
            {"text": "手まり寿司の贅沢", "y": 0.85, "size": 18, "color": (220, 220, 220), "spacing": 2, "align": "left", "font": "body"},
        ],
        "text_delay": 0.4,
    },
    {   # ご飯
        ...
        "effect": "zoom_tilt",
        "texts": [
            {"text": "ご  飯", "y": 0.78, "size": 42, "color": WHITE, "spacing": 10, "align": "left", "font": "title"},
            {"text": "えびと緑のハーモニー", "y": 0.85, "size": 18, "color": (220, 220, 220), "spacing": 2, "align": "left", "font": "body"},
        ],
        "text_delay": 0.4,
    },
    {   # デザート
        ...
        "effect": "zoom_in",
        "texts": [
            {"text": "デザート", "y": 0.78, "size": 42, "color": WHITE, "spacing": 10, "align": "left", "font": "title"},
            {"text": "苺・メロン・マンゴーの甘美", "y": 0.85, "size": 18, "color": (220, 220, 220), "spacing": 2, "align": "left", "font": "body"},
        ],
        "text_delay": 0.4,
    },
    {   # エンディング — 店舗情報
        ...
        "effect": "zoom_in",
        "texts": [
            {"text": "接待・記念日に", "y": 0.28, "size": 22, "color": WHITE, "spacing": 4, "font": "body"},
            {"text": "━━━━", "y": 0.35, "size": 16, "color": GOLD},
            {"text": "大嵓埜", "y": 0.42, "size": 56, "color": WHITE, "spacing": 16, "font": "title"},
            {"text": "06-6341-3535", "y": 0.54, "size": 34, "color": GOLD, "spacing": 6, "font": "accent"},
            {"text": "北新地 FOODEAR ビル 3F", "y": 0.62, "size": 16, "color": (180, 180, 180), "spacing": 2, "font": "body"},
        ],
        "text_delay": 0.4,
    },
]
